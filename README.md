...
| Goal | Start here |
|---|---|
| Run the full design workflow | [perfect-design-pipeline.md](perfect-design-pipeline.md) |
| Find the right skill for a specific problem | [SKILL-CHEATSHEET.md](SKILL-CHEATSHEET.md) |
| Install or export only the essential skills | [SKILL-TIERS.md](SKILL-TIERS.md) |
| Browse all vendored sources | [skills/](skills/) |
| Check source repos, owners, and licenses | [SKILL-SOURCES.md](SKILL-SOURCES.md) |
...
The must-have core is tracked in [manifests/must-have-skills.json](manifests/must-have-skills.json). To generate a standalone folder and ZIP for importing into other developer tools, run:
